...
<nav class="navbar bg-light fixed-top shadow">
    <div class="container-fluid">
        ...
        <div class="offcanvas offcanvas-end" tab-index="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div class="offcanvas-body">
                ...
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    <li class="nav-item">
                        <a href="{{ route('dashboard') }}" class="nav-link"><i class="bi bi-person"></i> Dashboard</a>
                    </li>
                    {{-- <li class="nav-item">
                        <a href="{{ route('register') }}" class="nav-link"><i class="bi bi-box-arrow-in-right"></i> Register</a>
                    </li> --}}
